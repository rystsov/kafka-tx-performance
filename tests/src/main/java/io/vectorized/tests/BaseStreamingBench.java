...
public class BaseStreamingBench extends Consts 
{
    String connection;
    ...
    public BaseStreamingBench(String connection, String source_topic, String target_topic) {
    ...
    {
        var bench = new BaseStreamingBench(getConnection(), "topic1", "topic2");
